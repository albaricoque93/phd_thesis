...
\newcommand{\myTitle}{Is simple always better?\xspace}
\newcommand{\mySubtitle}{The consequences of relaxing simplifying assumptions in models of biotic interactions }
