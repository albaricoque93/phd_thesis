...
\part{Introduction}
\include{Chapters/Introduction} % Chapter 2 % Second part of the thesis
\part{Frameworks for including biotic and abiotic complexity in models of biotic interactions}
\include{Chapters/Bee_foraging} % Chapter 3
\include{Chapters/Bayesian_competition}
\include{Chapters/Coexistence_alleles} % Chapter 4 - empty template
%\part{Discussion}
\part{Final words}
